...
lm.1_l <- lm(targdol_l~datead6, data= train_lm)
lm.2_l <- lm(targdol_l~datelp6, data= train_lm)
lm.3_l<- lm(targdol_l~slstyr, data= train_lm)
lm.4_l <- lm(targdol_l~slslyr, data= train_lm)
lm.5_l <- lm(targdol_l~sls2ago, data= train_lm)
lm.6_l <- lm(targdol_l~sls3ago, data= train_lm)
...
```{r}
fit_1 <- lm(targdol_l~ . -targdol -lpuryear -train -falord -sprord -oldSales , data=train_lm)
summary(fit_1)
```
